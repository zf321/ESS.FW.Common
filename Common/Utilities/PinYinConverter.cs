...
namespace ESS.FW.Common.Utilities
{
    ...
    public class PinYinConverter
    {
            ...
            try
            {
                ...
                foreach (char vChar in strText)
                {
                    ...
                    if ((vChar >= 'a' && vChar <= 'z') || (vChar >= 'A' && vChar <= 'Z')
                        || char.IsNumber(vChar) || char.IsPunctuation(vChar) || char.IsSeparator(vChar))
                    {
        ...
        private static string[] ChineseCharList =
        {
            ...
            "C燀瘁粹翠膵膬竁襊臎邨村皴澊竴存刌忖寸籿搓瑳遳磋撮蹉醝髊虘嵯嵳痤矬蒫鹾鹺齹脞剉剒厝夎挫莝莡措逪棤锉蓌错銼刂刹畜曾膪澶骣粢",
            "D詫襜譂奲虰坘蚳赿跮揰裯儔幬篅搥錞踧吋咑哒耷畣搭嗒褡噠墶达妲怛垯炟羍荙匒笪答詚跶瘩靼薘鞑燵繨蟽躂鐽龖龘打大亣眔橽呆獃懛歹傣代汏轪侢垈岱帒甙绐迨带待怠柋殆玳贷帯軑埭",
